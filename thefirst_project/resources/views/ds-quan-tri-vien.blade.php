...
<script type="text/javascript">
        ...
        $(document).ready(function(){$("#quan-tri-vien-datatable").DataTable({language:{paginate:{previous:"<i class='mdi mdi-chevron-left'>",next:"<i class='mdi mdi-chevron-right'>"}},drawCallback:function(){$(".dataTables_paginate > .pagination").addClass("pagination-rounded")}});});
        </script>
@endsection
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="quan-tri-vien-datatable" class="table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                    @foreach($quanTriVien as $tungquanTriVien)
                                        <tr>
                                            <td>{{ $tungquanTriVien->id }}</td>
                                            <td>{{ $tungquanTriVien->ten_dang_nhap }}</td>
                                            <td>{{ $tungquanTriVien->mat_khau}}</td>
                                            <td>{{ $tungquanTriVien->ho_ten }}</td>                                            
                                            <td>
